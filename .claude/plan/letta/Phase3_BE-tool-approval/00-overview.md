...
- [x] Forwarding request includes HMAC SHA-256 signature for security.
- [x] Multi-org isolation is strictly enforced.
- [x] Send tool return back to Letta Engine upon successful execution.

### Pending 🔴
- [ ] Detects `approval_request_message` in stream (for manual approval workflow).
